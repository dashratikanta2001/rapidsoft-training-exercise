...
//		String message = "<div>"
//				+ "<h2>OTP for login</h2>"
//				+ "<p> Please do not share the otp to anyone."
//				+ "<h3>OTP - "+(int)(Math.random()*1000000)
//				+ "</h3>"
//				+ "<p>This otp will only valid for 3 minutes."
//				+ "</div>";
//		String to = email;
//		String from = env.getProperty("spring.mail.username");
//		boolean sendEmail = sendEmail(message, subject, to, from);
//		
//		return sendEmail;
//	}
//
